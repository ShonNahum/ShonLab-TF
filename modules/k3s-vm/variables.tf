...
variable "vm_desc"       { type = string; default = "" }
...
variable "ip_address"     { type = string; default = "dhcp" }
variable "gateway"        { type = string; default = "" }
variable "dns"            { type = string; default = "1.1.1.1 8.8.8.8" }

variable "ssh_user"            { type = string; default = "ubuntu" }
variable "ssh_public_key"      { type = string; sensitive = true }
variable "ssh_private_key_path"{ type = string; default = "~/.ssh/id_ed25519" }
